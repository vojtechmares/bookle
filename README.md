...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create doodle-9983
  fly apps create doodle-9983-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app doodle-9983
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app doodle-9983-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'doodle-9983-staging' does not match app name in config file 'doodle-9983'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name doodle-9983-db
  fly postgres attach --app doodle-9983 doodle-9983-db

  fly postgres create --name doodle-9983-staging-db
  fly postgres attach --app doodle-9983-staging doodle-9983-staging-db
  ```
